#include "pch.h"
#include "DirectX11PracticeMain.h"
#include "Common\DirectXHelper.h"

using namespace DirectX11Practice;
using namespace Windows::Foundation;
using namespace Windows::System::Threading;
using namespace Concurrency;

// 애플리케이션이 로드되면 애플리케이션 자산을 로드하고 초기화합니다.
DirectX11PracticeMain::DirectX11PracticeMain(const std::shared_ptr<DX::DeviceResources>& deviceResources) :
...
DirectX11PracticeMain::~DirectX11PracticeMain()
{
	// 디바이스 알림 등록 취소
...
void DirectX11PracticeMain::CreateWindowSizeDependentResources() 
{
...
void DirectX11PracticeMain::Update() 
{
	// 장면 개체를 업데이트합니다.
	m_timer.Tick([&]()
	{
...
bool DirectX11PracticeMain::Render() 
{
...
void DirectX11PracticeMain::OnDeviceLost()
{
...
void DirectX11PracticeMain::OnDeviceRestored()
{
